...
const BotaoEmpresas = () => {
  function preencheTabela() {
    ...
    var tabela = (document.getElementById('minhaTabela').style.display =
      'block');
    const URL = `https://my-json-server.typicode.com/tractian/fake-api/companies`;
    fetch(URL)
      ...
      .then((data) => {
        ...
        titulo1.innerText = 'Id';
        titulo2.innerText = 'Name';
        titulo3.innerText = '';
        titulo4.innerText = '';
        titulo5.innerText = '';
        titulo6.innerText = '';
  ...
  return (
    <>
      <button title="Empresas" onClick={preencheTabela}>
        <h2>Verificar Empresas</h2>
      </button>
    </>
  );
};
export default BotaoEmpresas;
